...
// Vai analisar qual o melhor tamanho para a logo de acordo com a densidade de pixels da tela
...
export default function Incidents() {
  ...
  async function loadIncidents() {
    ...
    // console.warn(response.data.incidents.length, response.data.incidents)
